...
class ShopScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          ...
          SliverToBoxAdapter(child: _accessories(context)),
          ...
          SliverToBoxAdapter(
            child: _horizontalCards(
              context,
              context.watch<ExperienceCardStore>().cards,
            ),
          ),
  ...
  // Danh mục — đồng bộ với CategoryStore (admin sửa, khách thấy)
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ProductImage(cat.imagePath, height: 45, fit: BoxFit.contain),
                  const SizedBox(height: 10),
                  Text(cat.name,
                      maxLines: 1,
                ...
                children: [
                  Expanded(
                    ...
                    child: Container(
                      ...
                      color: Colors.white,
                      child: ProductImage(item.image, fit: BoxFit.cover),
                    ),
                  ),
                  Expanded(
                    flex: 4,
                          ...
                          if (item.overline != null) ...[
                            Text(item.overline!,
                                style: TextStyle(
                                    fontSize: 13,
                                    color:
                                        item.textColor.withValues(alpha: 0.6),
  ...
  // Khám phá sản phẩm mới — đồng bộ với ShopCardStore (admin sửa, khách thấy)
                    ...
                    children: [
                      Positioned.fill(
                        child: Padding(
                          ...
                          child:
                              ProductImage(product.image, fit: BoxFit.contain),
                        ),
                      ),
                      Positioned(
                        left: 0,
